...
admin	admin	GET:/api/admin/snapshot,GET:/api/admin/trading_account,GET:/api/admin/strategy_runtime/replay,POST:/api/admin/system/startup,POST:/api/admin/backup,GET:/api/admin/data/export,POST:/api/admin/data/import,GET:/api/admin/data/import/{job_id},GET:/api/admin/database/tables,GET:/api/admin/database/table/{table_name},GET:/api/admin/cache/status,POST:/api/admin/cache/clear,POST:/api/admin/data/clear_sample_state,GET:/api/admin/access_logs,GET:/api/admin/access_security,POST:/api/admin/access_security/block,POST:/api/admin/access_security/block_all,POST:/api/admin/access_security/unblock,GET:/api/admin/frontend_users,POST:/api/admin/frontend_users,PATCH:/api/admin/frontend_users/{username},POST:/api/admin/frontend_users/{username}/password,POST:/api/admin/frontend_users/{username}/ban,POST:/api/admin/frontend_users/{username}/unban,DELETE:/api/admin/frontend_users/{username},POST:/api/admin/restart
jobs	jobs	GET:/api/jobs/status,GET:/api/jobs/logs,POST:/api/jobs/scheduler/start,POST:/api/jobs/scheduler/stop,POST:/api/jobs/{job_name}/pause,POST:/api/jobs/{job_name}/resume,POST:/api/jobs/{job_name}/stop,POST:/api/jobs/news/fetch,POST:/api/jobs/market/sync,POST:/api/jobs/ai/analyze,POST:/api/jobs/trading/run,POST:/api/jobs/strategy/replay,POST:/api/jobs/frontend/precompute,POST:/api/jobs/daily/run
