...
admin	admin	GET:/api/admin/snapshot,GET:/api/admin/trading_account,POST:/api/admin/system/startup,POST:/api/admin/backup,GET:/api/admin/data/export,POST:/api/admin/data/import,GET:/api/admin/data/import/{job_id},GET:/api/admin/database/tables,GET:/api/admin/database/table/{table_name},POST:/api/admin/data/clear_sample_state,GET:/api/admin/access_logs,GET:/api/admin/frontend_users,POST:/api/admin/frontend_users,PATCH:/api/admin/frontend_users/{username},POST:/api/admin/frontend_users/{username}/password,POST:/api/admin/frontend_users/{username}/ban,POST:/api/admin/frontend_users/{username}/unban,DELETE:/api/admin/frontend_users/{username},POST:/api/admin/restart
